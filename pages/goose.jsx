...
export default function Goose() {
  return (
    <div className="bg-gradient-to-r from-red-500 via-red-400 to-orange-500">
      ...
      <h2 className="tracking-widest flex justify-center font-bold text-xl p-2 pb-12 text-white">
        Mobile App Redesign
      </h2>
      ...
      <h6 className="text-center tracking-widest m-6">
        ...
        >
          {" "}
          <span className="tracking-widest text-white text-xs bg-red-300 hover:bg-red-500 rounded-full py-2 px-4">
            Figma Prototype
          </span>
        </a>
      </h6>
